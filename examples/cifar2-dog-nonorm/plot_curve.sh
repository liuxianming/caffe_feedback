...
python $TOOLS/plot_training_log_multiple.py 40 curves_acc.png train_ff.log train_fb.log train_fb_2layer.log
python $TOOLS/plot_training_log_multiple.py 82 curves_loss.png train_ff.log train_fb.log train_fb_2layer.log
#sz curves_acc.png 
#sz curves_loss.png
